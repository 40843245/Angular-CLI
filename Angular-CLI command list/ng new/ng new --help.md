...
Options:
  ...
  -c, --collection             A collection of schematics to use in generating the initial application.         [string]
      ...
      --experimental-zoneless  Create an application that does not utilize zone.js.           [boolean] [default: false]
  ...
  -t, --inline-template        Include template inline in the component TS file. By default, an external template file
                               is created and referenced in the component TypeScript file.                     [boolean]
      ...
      --package-manager        The package manager used to install dependencies.
                                                                [string] [choices: "npm", "yarn", "pnpm", "cnpm", "bun"]
  -p, --prefix                 The prefix to apply to generated selectors for the initial project.
      ...
      --server-routing         Creates a server application using the Server Routing and App Engine APIs (Developer
                               Preview).                                                                       [boolean]
  ...
  -S, --skip-tests             Do not generate "spec.ts" test files for the new project.      [boolean] [default: false]
      --ssr                    Creates an application with Server-Side Rendering (SSR) and Static Site Generation
                               (SSG/Prerendering) enabled.                                                     [boolean]
